...
router.get(
  "/getbyuserid/:id",
  authMiddleware,
  wagroupController.getWhatsAppGroupsByUserId
);
...
router.put(
  "/active/:id",
  authMiddleware,
  wagroupController.updateSectionactive
);
router.get(
  "/active/:userId",
  authMiddleware,
  wagroupController.getAllActiveSections
);
router.get(
  "/whatsapp-group/:id",
  authMiddleware,
  wagroupController.getWhatsAppGroupById
);
