...
router.get(
  "/all/sales/marketing/:id",
  authMiddleware,
  eventController.getEventsbysalesandmarketing
);
...
router.get(
  "/patner/getall/:id",
  authMiddleware,
  eventController.getEventsbypatner
);
...
router.get(
  "/scanner/:scannerId",
  authMiddleware,
  eventController.getAllEventsByScanner
);

router.get(
  "/optomatics/:optimisticId",
  authMiddleware,
  eventController.getAllEventsByOptimistic
);

router.put(
  "/email/:id",
  authMiddleware,
  eventController.createOrUpdateEventEmail
);

router.get(
  "/email/:id",
  authMiddleware,
  eventController.getEventEmail
);
