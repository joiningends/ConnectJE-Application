...
router.get(
  "/:id/total-sent-messages",
  authMiddleware,
  clientController.getTotalSentMessages
);
router.get(
  "/:id/messages",
  authMiddleware,
  clientController.getMessagesByDateRange
);
router.get("/pdf", authMiddleware, clientController.generatePDF);
router.put(
  "/updateTotalCredit",
  authMiddleware,
  clientController.updateTotalCredit
);
router.put(
  "/einvoice/updateTotalCredit",
  authMiddleware,
  clientController.updateTotalCrediteinvoice
);
