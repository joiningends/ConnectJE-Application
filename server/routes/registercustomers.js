...
router.get(
  "/scanner/:registerId/:eventId/:scannerId",
  authMiddleware,
  registrationController.scanQRCode
);
router.get(
  "/opt/:registerId/:eventId/:opId",
  authMiddleware,
  registrationController.scanQRCodeop
);
router.get(
  "/all/byscanner/:eventId",
  authMiddleware,
  registrationController.getScannedCustomersbyscanner
);
router.get(
  "/byop/:eventId",
  authMiddleware,
  registrationController.getScannedCustomersbyop
);
router.get(
  "/getbyid/:id",
  authMiddleware,
